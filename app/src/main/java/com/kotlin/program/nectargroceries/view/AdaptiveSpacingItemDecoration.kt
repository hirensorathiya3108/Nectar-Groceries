package com.kotlin.program.nectargroceries.view
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        when (val layoutManager = parent.layoutManager) {
            is GridLayoutManager -> {
                makeGridSpacing(outRect, parent.getChildAdapterPosition(view), state.itemCount, layoutManager.orientation, layoutManager.spanCount, layoutManager.reverseLayout)
            }
            is LinearLayoutManager -> {
                ...
                makeLinearSpacing(outRect, parent.getChildAdapterPosition(view), state.itemCount, linearOrientation, isReversed)
            }
